            ...
            <div class="inner-header">
                <div class="row">
                    <div class="col-lg-2 col-md-2">
                        <div class="logo">
                            <a href="#">
                                <img src="/img/Droppoint-logo.png" alt="">
                            </a>
                        </div>
                    </div>
                                ...
                                <div class="cart-hover">
                                    <div class="select-items">
                                        <table>
                                            <tbody>
                                                <tr>
                                                    <td class="si-pic"><img src="/img/s1.jpg" alt=""></td>
                                                    <td class="si-text">
                                                ...
                                                <tr>
                                                    <td class="si-pic"><img src="/img/s9.jpg" alt=""></td>
                                                    <td class="si-text">
                                                        <div class="product-selected">
                                                            <p>$60.00 x 1</p>
                                                            <h6>	Event assistant </h6>
                                                        </div>
                                                    </td>
                                                    <td class="si-close">
                                                        <i class="ti-close"></i>
                ...
                <div class="nav-depart">
                    <div class="depart-btn">
                        ...
                        <ul class="depart-hover">
                            <li class="active"><a href="#">Logistics services</a></li>
                ...
                <div class="col-lg-3">
                    <div class="footer-left">
                        <div class="footer-logo">
                            <img src="/img/Droppoint-logo-w.png" alt="">
                        </div>
                        <ul>
