...
<div class='col-lg-12 '>
    ...
    <div class="form-group" >
        ...
        {{ Form::number('active', null, array('class' => 'form-control')) }}
    </div>
    <div class="form-group" >
    ...
    <div class="form-group" >
        ...
        {{ Form::number('verified', null, array('class' => 'form-control')) }}
    </div>
    <div class="form-group" >
        {{ Form::label('verified_email', 'verified_email') }}
        {{ Form::number('verified_email', null, array('class' => 'form-control')) }}
    </div>
    <div class="form-group" >
        {{ Form::label('verified_phone', 'verified_phone') }}
        {{ Form::number('verified_phone', null, array('class' => 'form-control')) }}
    </div>
    <div class="form-group" >
        {{ Form::label('online', 'online') }}
        {{ Form::number('online', null, array('class' => 'form-control')) }}
    </div>
    <div class="form-group">
